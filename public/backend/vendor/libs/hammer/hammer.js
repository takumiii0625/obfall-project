        ...
        var t = {
                840: function (t, e, n) {
                    ...
                    !(function (r, s, o, a) {
                            ...
                            (n.isFirst = !!s),
                                ...
                                (function (t, e) {
                                    ...
                                    (e.timeStamp = v()),
                                        ...
                                        (function (t, e) {
                                            var n = e.center,
                                                ...
                                                r = t.prevDelta || {},
                                                s = t.prevInput || {};
                                            (e.eventType !== k && s.eventType !== L) || ((r = t.prevDelta = { x: s.deltaX || 0, y: s.deltaY || 0 }), (i = t.offsetDelta = { x: n.x, y: n.y })),
                                    ...
                                    (e.overallVelocityX = p.x),
                                        ...
                                        (e.scale = o ? ((c = o.pointers), at((l = i)[0], l[1], tt) / at(c[0], c[1], tt)) : 1),
                                        (e.rotation = o
                                            ? (function (t, e) {
                        ...
                        b(pt, et, {
                            handler: function (t) {
                                ...
                                e & k && 0 === t.button && (this.pressed = !0),
                                    2 & e && 1 !== t.which && (e = L),
                                    this.pressed && (e & L && (this.pressed = !1), this.callback(this.manager, e, { pointers: [t], changedPointers: [t], pointerType: q, srcEvent: t }));
                            },
                        });
                        var ft = { pointerdown: k, pointermove: 2, pointerup: L, pointercancel: H, pointerout: H },
                        ...
                        r.MSPointerEvent && !r.PointerEvent && ((dt = "MSPointerDown"), (mt = "MSPointerMove MSPointerUp MSPointerCancel")),
                            b(gt, et, {
                                handler: function (t) {
                                    var e = this.store,
                                        n = !1,
                                    ...
                                    r & k && (0 === t.button || o) ? a < 0 && (e.push(t), (a = e.length - 1)) : r & (L | H) && (n = !0),
                                        a < 0 || ((e[a] = t), this.callback(this.manager, r, { pointers: e, changedPointers: [t], pointerType: s, srcEvent: t }), n && e.splice(a, 1));
                                },
                            });
                        var yt = { touchstart: k, touchmove: 2, touchend: L, touchcancel: H };
                        function Tt() {
                        ...
                        b(Tt, et, {
                            handler: function (t) {
                                ...
                                if ((e === k && (this.started = !0), this.started)) {
                                    ...
                                    e & (L | H) && n[0].length - n[1].length == 0 && (this.started = !1), this.callback(this.manager, e, { pointers: n[0], changedPointers: n[1], pointerType: W, srcEvent: t });
                                }
                            },
                        });
                        var bt = { touchstart: k, touchmove: 2, touchend: L, touchcancel: H },
                        ...
                        b(At, et, {
                            handler: function (t) {
                                var e = bt[t.type],
                                    n = St.call(this, t, e);
                                n && this.callback(this.manager, e, { pointers: n[0], changedPointers: n[1], pointerType: W, srcEvent: t });
                            },
                        });
                        var _t = 2500;
                        function Pt() {
                        ...
                        (kt.prototype = {
                            ...
                            b(Gt, Vt, {
                                ...
                                directionTest: function (t) {
                                    ...
                                    return (
                                        r & e.direction ||
                                            (e.direction & $ ? ((r = 0 === s ? U : s < 0 ? V : G), (n = s != this.pX), (i = Math.abs(t.deltaX))) : ((r = 0 === o ? U : o < 0 ? Z : B), (n = o != this.pY), (i = Math.abs(t.deltaY)))),
                                        (t.direction = r),
                            ...
                            b(Jt, Vt, {
                                defaults: { event: "swipe", threshold: 10, velocity: 0.3, direction: $ | J, pointers: 1 },
                                getTouchAction: function () {
                                ...
                                attrTest: function (t) {
                                    ...
                                    return (
                                        n & ($ | J) ? (e = t.overallVelocity) : n & $ ? (e = t.overallVelocityX) : n & J && (e = t.overallVelocityY),
                            ...
                            (Qt.defaults = {
                                ...
                                inputTarget: null,
                                inputClass: null,
                                preset: [[$t, { enable: !1 }], [Zt, { enable: !1 }, ["rotate"]], [Jt, { direction: $ }], [Gt, { direction: $ }, ["swipe"]], [Kt], [Kt, { event: "doubletap", taps: 2 }, ["tap"]], [Bt]],
