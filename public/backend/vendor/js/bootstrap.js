...
!(function (e, t) {
    ...
    return (function () {
        ...
        var ie = {
                ...
                fn: function (e) {
                    ...
                    null != t.modifiersData.popperOffsets &&
                        (t.styles.popper = Object.assign({}, t.styles.popper, ne(Object.assign({}, l, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: a, roundOffsets: c })))),
                ...
                if (!t.modifiersData[i]._skip) {
                    for (
                        ...
                        var M = x[N],
                            ...
                            B = [r, o].indexOf(F) >= 0,
                            R = B ? "width" : "height",
                            W = _e(t, { placement: M, boundary: y, rootBoundary: b, altBoundary: w, padding: _ }),
                            z = B ? (H ? a : s) : H ? o : r;
                        S[R] > L[R] && (z = se(z));
                        var q = se(z),
                            V = [];
        ...
        function Te(e, t, n) {
            ...
            return (
                (o || (!o && !n)) &&
                    (("body" !== x(t) || de(s)) && (l = (i = t) !== S(i) && j(i) ? { scrollLeft: (r = i).scrollLeft, scrollTop: r.scrollTop } : ue(i)), j(t) ? (((u = R(t, !0)).x += t.clientLeft), (u.y += t.clientTop)) : s && (u.x = fe(s))),
                        ...
                        forceUpdate: function () {
                            if (!l) {
                                var e = s.elements,
                                    ...
                                    n = e.popper;
                                if (Se(t, n)) {
                                    (s.rects = { reference: Te(t, X(n), "fixed" === s.options.strategy), popper: W(n) }),
                                        (s.reset = !1),
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    return (
                                        (this._inNavbar || "static" === this._config.display) && (Ht(this._menu, "popper", "static"), (e.modifiers = [{ name: "applyStyles", enabled: !1 }])), qe(qe({}, e), mt(this._config.popperConfig, [e]))
                                    );
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    this._isShown ||
                                        ...
                                        It.trigger(this._element, Wi, { relatedTarget: e }).defaultPrevented ||
                                        ((this._isShown = !0),
                                        (this._isTransitioning = !0),
                                ...
                                value: function (e) {
                                    for (var t = 0, i = Object.entries(e); t < i.length; t++) {
                                        var r = Ye(i[t], 2),
                                            o = r[0],
                                            a = r[1];
                                        Ne(We(n.prototype), "_typeCheckConfig", this).call(this, { selector: o, entry: a }, Ar);
                                    }
                                },
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    if (this._isWithContent() && this._isEnabled) {
                                        ...
                                        if (!t.defaultPrevented && n) {
                                            ...
                                            if (
                                                (this._element.ownerDocument.documentElement.contains(this.tip) || (r.append(i), It.trigger(this._element, this.constructor.eventName("inserted"))),
                                ...
                                value: function (e) {
                                    return (
                                        this._templateFactory
                                            ...
                                            : (this._templateFactory = new Or(qe(qe({}, this._config), {}, { content: e, extraClass: this._resolvePossibleFunction(this._config.customClass) }))),
                                        this._templateFactory
                                    );
                                },
                            },
                    ...
                    Ue(
                        ...
                        [
                            ...
                            },
                            {
                                key: "_process",
                                value: function (e) {
                                    this._activeTarget !== e && (this._clearActiveClass(this._config.target), (this._activeTarget = e), e.classList.add(Vr), this._activateParents(e), It.trigger(this._element, Wr, { relatedTarget: e }));
                                },
                            },
                            {
                                        ...
                                        this._queueCallback(
                                            function () {
                                                "tab" === e.getAttribute("role")
                                                    ? (e.removeAttribute("tabindex"), e.setAttribute("aria-selected", !0), n._toggleDropDown(e, !0), It.trigger(e, to, { relatedTarget: t }))
                                                    : e.classList.add(po);
                                            },
                                            e,
                                ...
                                value: function (e, t) {
                                    ...
                                    e &&
                                        ...
                                        this._queueCallback(
                                            function () {
                                                "tab" === e.getAttribute("role")
                                                    ? (e.setAttribute("aria-selected", !1), e.setAttribute("tabindex", "-1"), n._toggleDropDown(e, !1), It.trigger(e, Zr, { relatedTarget: t }))
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    if ([oo, ao, so, co, lo, uo].includes(e.key)) {
                                        ...
                                        t && (t.focus({ preventScroll: !0 }), n.getOrCreateInstance(t).show());
                                    }
                                },
                            },
                            {
