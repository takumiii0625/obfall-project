        ...
        n = {
            ...
            plotOptions: {
                radialBar: {
                    ...
                    dataLabels: { name: { offsetY: 15, color: e, fontSize: "15px", fontWeight: "500", fontFamily: "Public Sans" }, value: { offsetY: -25, color: r, fontSize: "22px", fontWeight: "500", fontFamily: "Public Sans" } },
                },
            },
