...
<body>
    ...
    <x-page-hero title="Service" sub="ITの力で、人と社会の可能性を広げる。" variant="hexgrid" />

    {{-- リード文 --}}
    <section class="sec">
        <div class="wrap">
            <p class="lead-text">
                自社開発・受託開発・脆弱性診断・SESの4つの事業を通じて、<br class="d-none d-md-inline">テクノロジーで人生をより豊かにします。
            </p>
        </div>
    </section>
        ...
        <div class="wrap">
            <div class="srv-grid">
                ...
                <article class="srv-card">
                    ...
                    <p class="srv-card__desc">人と社会の可能性を広げる、自社プロダクト。</p>
                    <a class="srv-card__link" href="{{ route('products') }}">詳しく見る <i class="bi bi-arrow-right"></i></a>
                </article>
                ...
                <article class="srv-card">
                    ...
                    <p class="srv-card__desc">ともにつくり、ともに前へ。</p>
                    <a class="srv-card__link" href="{{ route('contract') }}">詳しく見る <i class="bi bi-arrow-right"></i></a>
                </article>

                {{-- 03 SES --}}
                <article class="srv-card">
                    <div class="srv-card__num">03</div>
                    <div class="srv-card__kicker">Team Support</div>
                    <h2 class="srv-card__title">SES</h2>
                    <div class="srv-card__en">IT &times; Team</div>
                    <p class="srv-card__desc">人が輝く現場を、技術で支える。</p>
                    <a class="srv-card__link" href="{{ route('ses') }}">詳しく見る <i class="bi bi-arrow-right"></i></a>
                </article>

                {{-- 04 脆弱性診断 --}}
                <article class="srv-card">
                    <div class="srv-card__num">04</div>
                    <div class="srv-card__kicker">Security</div>
                    <h2 class="srv-card__title">脆弱性診断</h2>
                    <div class="srv-card__en">Security &times; Engineering</div>
                    <p class="srv-card__desc">安全は、後付けではなく、設計から。</p>
                    <a class="srv-card__link" href="{{ route('security') }}">詳しく見る <i class="bi bi-arrow-right"></i></a>
                </article>
        ...
        <div class="wrap">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="--bs-breadcrumb-divider:'＞'; font-size: clamp(.875rem, 1.8vw, 1rem);">
                    ...
                    <li class="breadcrumb-item">サービス</li>
                </ol>
            </nav>
        </div>
    </div>
