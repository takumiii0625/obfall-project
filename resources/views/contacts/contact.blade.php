...
<head>
    ...
    <title>Contact | OBFall Inc.</title>
    <style>
        :root {
            --ink: #1a1a1a;
            --muted: #5a6978;
        ...
        .privacy-agree .form-check {
            display: inline-flex;
            align-items: center;
            gap: 8px;
        }
        .privacy-agree .form-check-input {
            width: 18px;
            height: 18px;
        }
        ...
        @media (max-width: 767.98px) {
            ...
            .privacy-box { padding: 24px 16px; max-height: 300px; }
...
<body>
    ...
    <x-page-hero title="Contact" sub="お気軽にお問い合わせください。" variant="mail" />
            ...
            <div class="form-card">
                <form method="post" action="{{ route('confirm') }}">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label" for="name">お名前（10文字以内）<span class="badge">必須</span></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label" for="email">メールアドレス<span class="badge">必須</span></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label" for="company">会社名<span class="badge">必須</span></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label" for="contents">お問い合わせ内容<span class="badge">必須</span></label>
                        <div class="col-sm-8">
    ...
    <section class="sec sec--alt">
        <div class="wrap">
            ...
            <div class="privacy-agree">
                ...
                <p class="alert alert-danger" style="display:inline-block; margin-top:8px;">{{ $errors->first('privacy_agree') }}</p>
                @endif
            </div>
