...
@section('meta')
<title>自社開発編集 | {{ config('app.name') }}</title>
@endsection
...
<div class="container-fluid flex-grow-1 container-p-y">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12">
                    <form method="POST" action="{{ App\Libraries\Utils::urlToPath(route('officeDevelopmentsEditConfirm', ['id' => $assign['record']->id])) }}" class="form" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-text d-flex align-items-center pt-0 pb-2 py-md-2 fs-6">
                                <input type="text" name="category" value="{{ old('category', $assign['record']->category) }}" id="category" class="form-control">
                            </div>
                            @error ('category')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-text d-flex align-items-start flex-column pt-0 pb-2 py-md-2 fs-6">
                                ...
                                <div class="mb-2">
                                    @if (!empty($assign['record']->inhouse_developments_image_url))
                                    <img id="imagePreview" src="{{ asset($assign['record']->inhouse_developments_image_url) }}" alt="商品画像" width="200">
                                    <input type="hidden" name="inhouse_developments_image_url" value="{{ $assign['record']->inhouse_developments_image_url }}">
                                    @endif
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-text d-flex align-items-center pt-0 pb-2 py-md-2 fs-6">
                                <input type="text" name="inhouse_developments_home_page_url" value="{{ old('inhouse_developments_home_page_url', $assign['record']->inhouse_developments_home_page_url) }}" id="inhouse_developments_home_page_url" class="form-control">
                            </div>
