...
@section('meta')
<title>自社開発編集確認 | {{ config('app.name') }}</title>
@endsection
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 pt-2">
                    <h5 class="card-title">自社開発編集確認</h5>
                </div>
            </div>
            ...
            <div class="row pt-3">
                <div class="col-12">
                    <form method="POST" action="{{ App\Libraries\Utils::urlToPath(route('officeDevelopmentsEditExecute', ['id' => $assign['record']->id])) }}" class="form" enctype="multipart/form-data">
                        @csrf
