...
<div class="container-fluid flex-grow-1 container-p-y">
    <div class="card p-3">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12">
                    <form method="POST" action="{{ App\Libraries\Utils::urlToPath(route('officeInitExecute')) }}" class="form" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <label class="col-md-3 col-form-label d-flex align-items-center pt-2 pb-0 py-md-2 fs-6 fw-bold" for="password" role="button">
                                <span class="text-danger">※&nbsp;</span> 新パスワード
                            </label>
                            <div class="col-md-8 form-text d-flex align-items-center pt-0 pb-2 py-md-2 fs-6">
                        ...
                        {{-- 進むボタン --}}
                        <div class="my-3">
                            <button type="submit" class="btn btn-success d-grid w-100 text-white text-break" id="submit">設定する</button>
                        </div>
